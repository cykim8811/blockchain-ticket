...
import { Calendar, MapPin, Ticket, LogIn, LogOut, LayoutDashboard } from "lucide-react";
        ...
        <div className="min-h-screen bg-background p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {events.map((event) => (
                        <Card key={event.id} className="overflow-hidden flex flex-col transition-all hover:shadow-lg">
